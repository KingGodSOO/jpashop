...
@RestController // @Controller + @ResponseBody -> 데이터를 바로 json이나 xml으로 반환할 때 쓰는 어노테이션
...
public class MemberApiController {
    ...
    public List<Member> memberV1() {
        return memberService.findMembers(); // @RestController 어노테이션 덕분에 json으로 자동 변환되어 리턴된다.
    }
    ...
    public UpdateMemberResponse updateMemberV2(
        ...
        Member findMember = memberService.findOne(id); // 커맨드와 쿼리를 분리하기 위해, 다시 엔티티를 조회해온다.
